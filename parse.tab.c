...
#line 119 "parse.tab.c" /* yacc.c:355  */
...
{
       0,    60,    60,    66,    72,    76,    82,    83,    86,    87,
      90,    91,    94,    95,    98,    99,   102,   105,   106,   109,
     110,   113,   114,   117,   118,   121,   125,   128,   132,   138,
     139,   142,   146,   149,   150,   153,   154,   157,   163,   170,
     174,   181,   185,   191,   196,   203,   204,   205,   206,   207,
     208,   209,   212,   249,   262,   267,   274,   284,   291,   295,
     299,   303,   307,   311,   315,   319,   323,   327,   331,   335,
     341,   346,   353,   354,   357,   361,   367,   368,   371,   372,
     375,   378,   381,   382,   383,   384,   385,   388,   391,   394,
     395,   398,   401,   402,   405,   406,   409,   410,   413,   414,
     417,   420,   423,   424,   427,   428,   429,   432,   437,   443,
     447,   450,   451,   454,   455,   458,   459,   462,   466,   472,
     478,   482,   485,   486,   489,   490,   493,   494,   495,   496,
     497,   498,   499,   500,   503,   504,   507,   508,   511,   512,
     515,   516,   520,   521,   524,   525,   528,   529,   532,   533,
     536,   539,   540,   543,   544,   547,   548,   551,   552,   555,
     556,   559,   561,   565,   566,   569,   570,   573,   574,   577,
     578,   581,   582,   585,   589,   593,   594,   597,   602,   606,
     611,   615,   619,   626,   631,   635,   636,   637,   638,   639,
     640,   641,   642,   643,   644,   645,   648,   656,   662,   666,
     670,   675,   681,   686,   690,   691,   694,   699,   712,   717,
     723,   728,   744,   748,   752,   756,   762,   772,   779,   783,
     787,   793,   798,   805,   807,   811,   816,   817,   818,   819,
     826,   832,   838,   841,   846,   852,   857,   864,   865,   868,
     869,   872,   873,   876,   877,   880,   884,   890,   891,   894,
     898,   902,   909,   910,   913,   914,   917,   918,   919,   922,
     923,   926,   927,   930,   931,   934,   935,   938,   939,   942,
     947,   954,   955,   958,   959,   962,   963,   966,   967,   970,
     971,   974,   975,   978,   981,   982,   985,   986,   989,   990,
     993,   994,   995,   998,   999,  1002,  1003,  1006,  1007,  1010,
    1011,  1014,  1015,  1018,  1019,  1022,  1023,  1026,  1027,  1030,
    1031,  1034,  1035,  1038,  1039
};
#endif
...
#line 213 "parse.y" /* yacc.c:1646  */
    {
		  ...
		  (yyval.node) = new StarasgBinaryNode((yyvsp[-2].node), (yyvsp[0].node));
              ...
              case DOUBLESTAREQUAL:
                  (yyval.node) = new DoubleStartasgBinaryNode((yyvsp[-2].node), (yyvsp[0].node));
                  pool.add((yyval.node));
                  break;
              case PERCENTEQUAL:
                  (yyval.node) = new PercentStartasgBinaryNode((yyvsp[-2].node), (yyvsp[0].node));
                  pool.add((yyval.node));
                  break;
            }
            /*if ($3 == NULL) {
...
#line 2282 "parse.tab.c" /* yacc.c:1646  */
    break;
...
#line 2607 "parse.tab.c" /* yacc.c:1646  */
    break;
...
#line 2649 "parse.tab.c" /* yacc.c:1646  */
    break;
...
#line 2727 "parse.tab.c" /* yacc.c:1646  */
    break;
