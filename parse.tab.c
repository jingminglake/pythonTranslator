...
#line 124 "parse.tab.c" /* yacc.c:355  */
...
#line 235 "parse.tab.c" /* yacc.c:355  */
};
...
{
       0,    72,    72,    79,   103,   108,   127,   135,   143,   144,
     147,   152,   159,   160,   163,   164,   167,   184,   189,   196,
     201,   209,   213,   219,   225,   233,   237,   240,   245,   252,
     256,   262,   269,   276,   280,   286,   290,   296,   302,   309,
     313,   320,   324,   330,   335,   344,   346,   348,   350,   352,
     354,   356,   360,   417,   434,   439,   468,   475,   485,   493,
     497,   501,   505,   509,   513,   517,   521,   526,   530,   534,
     538,   544,   549,   556,   560,   566,   571,   578,   579,   582,
     583,   586,   589,   592,   594,   596,   601,   603,   607,   610,
     613,   619,   627,   630,   631,   634,   635,   638,   639,   642,
     643,   646,   649,   652,   653,   656,   657,   658,   661,   666,
     672,   676,   679,   680,   683,   684,   687,   688,   691,   695,
     701,   707,   711,   714,   715,   718,   719,   722,   724,   726,
     728,   730,   732,   737,   739,   743,   749,   757,   758,   761,
     762,   765,   766,   769,   770,   773,   774,   777,   778,   781,
     782,   785,   788,   789,   792,   793,   796,   797,   800,   801,
     804,   805,   808,   813,   820,   826,   835,   836,   839,   840,
     843,   844,   847,   848,   851,   855,   859,   863,   869,   874,
     878,   883,   889,   893,   900,   905,   935,   939,   943,   947,
     951,   955,   959,   963,   967,   971,   975,   981,   986,   994,
     998,  1006,  1011,  1019,  1024,  1037,  1039,  1043,  1048,  1061,
    1066,  1072,  1077,  1096,  1100,  1104,  1108,  1114,  1127,  1134,
    1138,  1142,  1148,  1154,  1169,  1175,  1182,  1187,  1189,  1191,
    1193,  1200,  1206,  1212,  1218,  1224,  1228,  1233,  1239,  1244,
    1251,  1252,  1255,  1256,  1259,  1260,  1263,  1264,  1267,  1271,
    1277,  1278,  1281,  1288,  1293,  1301,  1302,  1305,  1306,  1309,
    1310,  1311,  1314,  1315,  1318,  1319,  1322,  1323,  1326,  1327,
    1330,  1331,  1334,  1339,  1346,  1347,  1350,  1351,  1354,  1355,
    1358,  1359,  1362,  1364,  1368,  1369,  1372,  1380,  1386,  1394,
    1398,  1404,  1405,  1408,  1413,  1418,  1425,  1430,  1436,  1440,
    1446,  1447,  1450,  1451,  1454,  1455,  1458,  1459,  1462,  1466,
    1472,  1473,  1476,  1477,  1480,  1482,  1486,  1487
};
#endif
...
#line 109 "parse.y" /* yacc.c:1646  */
    {
	    ...
	    (yyval.node) = new NewStmtNode((yyvsp[0].node));
	    pool.add((yyval.node));
...
#line 168 "parse.y" /* yacc.c:1646  */
    {
	    ...
	    (yyval.node) = new FuncDefNode((yyvsp[-3].id), *(yyvsp[-2].nodes), (yyvsp[0].node));
          }
          else {
...
#line 202 "parse.y" /* yacc.c:1646  */
    {
          ...
          (yyval.nodes)->push_back((yyvsp[-2].node));
...
#line 2203 "parse.tab.c" /* yacc.c:1646  */
    break;
...
#line 2288 "parse.tab.c" /* yacc.c:1646  */
    break;
...
#line 2621 "parse.tab.c" /* yacc.c:1646  */
    break;
...
#line 602 "parse.y" /* yacc.c:1646  */
    { (yyval.node) = nullptr; }
#line 2666 "parse.tab.c" /* yacc.c:1646  */
    break;

  case 87:
#line 604 "parse.y" /* yacc.c:1646  */
    { (yyval.node) = nullptr; }
#line 2672 "parse.tab.c" /* yacc.c:1646  */
    break;
...
#line 821 "parse.y" /* yacc.c:1646  */
    {
          (yyval.node) = (yyvsp[-1].node);
          static_cast<SuiteNode*>((yyval.node))->insertStmt((yyvsp[0].node));
...
#line 827 "parse.y" /* yacc.c:1646  */
    {
          ...
          pool.add((yyval.node));
          static_cast<SuiteNode*>((yyval.node))->insertStmt((yyvsp[0].node)); // use cast because insertStmt() is not a virtual function
	   ...
	   switch((yyvsp[-1].tokenId)) {
	     case LESS:
  	     ...
  	     case GREATER:
               ...
               break;
	     case EQEQUAL:
               (yyval.node) = new EqEqualNode((yyvsp[-2].node), (yyvsp[0].node));
	       break;
             case GREATEREQUAL:
               (yyval.node) = new GreaterEqualNode((yyvsp[-2].node), (yyvsp[0].node));
	       break;
	     case LESSEQUAL:
               (yyval.node) = new LessEqualNode((yyvsp[-2].node), (yyvsp[0].node));
	       break;
	       /*             case GRLT:
               $$ = new GRLTNode($1, $3);
	       break; */
             case NOTEQUAL:
               (yyval.node) = new NotEqualNode((yyvsp[-2].node), (yyvsp[0].node));
	       break;
           }
           pool.add((yyval.node));
...
#line 3051 "parse.tab.c" /* yacc.c:1646  */
    break;
...
#line 3254 "parse.tab.c" /* yacc.c:1646  */
    break;
...
#line 3304 "parse.tab.c" /* yacc.c:1646  */
    break;
...
#line 3322 "parse.tab.c" /* yacc.c:1646  */
    break;
...
#line 1155 "parse.y" /* yacc.c:1646  */
    {
           if (!((yyvsp[0].nodes)->empty())) {
              ...
              (yyval.node) = new CallNode(n, (yyvsp[0].nodes));
              pool.add((yyval.node));
           }
           else {
              (yyval.node) = (yyvsp[-1].node);
...
#line 3349 "parse.tab.c" /* yacc.c:1646  */
    break;
...
#line 1188 "parse.y" /* yacc.c:1646  */
    { (yyval.node) = nullptr; }
#line 3373 "parse.tab.c" /* yacc.c:1646  */
    break;

  case 228:
#line 1190 "parse.y" /* yacc.c:1646  */
    { (yyval.node) = nullptr; }
#line 3379 "parse.tab.c" /* yacc.c:1646  */
    break;
...
#line 3406 "parse.tab.c" /* yacc.c:1646  */
    break;

  case 232:
#line 1207 "parse.y" /* yacc.c:1646  */
    {
            printDebugMsg(std::string("INTNUMBER: ") + std::to_string((yyvsp[0].intNumber)) + std::string(" -> atom"));
...
#line 3451 "parse.tab.c" /* yacc.c:1646  */
    break;
...
#line 3459 "parse.tab.c" /* yacc.c:1646  */
    break;
...
#line 3477 "parse.tab.c" /* yacc.c:1646  */
    break;
...
#line 3485 "parse.tab.c" /* yacc.c:1646  */
    break;
...
#line 3493 "parse.tab.c" /* yacc.c:1646  */
    break;

  case 252:
#line 1282 "parse.y" /* yacc.c:1646  */
    {
            (yyval.node) = new TrailerNode((yyvsp[-1].nodes));
            pool.add((yyval.node));
            delete (yyvsp[-1].nodes);
...
#line 3513 "parse.tab.c" /* yacc.c:1646  */
    break;
...
#line 3541 "parse.tab.c" /* yacc.c:1646  */
    break;

  case 282:
#line 1363 "parse.y" /* yacc.c:1646  */
    { deleteName((yyvsp[-5].id)); }
#line 3547 "parse.tab.c" /* yacc.c:1646  */
    break;

  case 283:
#line 1365 "parse.y" /* yacc.c:1646  */
    { deleteName((yyvsp[-2].id)); }
#line 3553 "parse.tab.c" /* yacc.c:1646  */
    break;

  case 286:
#line 1373 "parse.y" /* yacc.c:1646  */
    { 
          (yyval.nodes) = (yyvsp[-1].nodes);
          (yyval.nodes)->push_back((yyvsp[0].node));
          printDebugMsg("star_argument_COMMA pick_argument -> arglist");
        }
#line 3563 "parse.tab.c" /* yacc.c:1646  */
    break;
...
#line 3573 "parse.tab.c" /* yacc.c:1646  */
    break;
...
#line 3583 "parse.tab.c" /* yacc.c:1646  */
    break;

  case 289:
#line 1395 "parse.y" /* yacc.c:1646  */
    {
          printDebugMsg("star_COMMA_argument COMMA argument -> star_COMMA_argument");
        }
#line 3591 "parse.tab.c" /* yacc.c:1646  */
    break;
...
#line 3599 "parse.tab.c" /* yacc.c:1646  */
    break;
...
#line 3608 "parse.tab.c" /* yacc.c:1646  */
    break;
...
#line 3617 "parse.tab.c" /* yacc.c:1646  */
    break;

  case 295:
#line 1419 "parse.y" /* yacc.c:1646  */
    {
          (yyval.node) = nullptr;
          printDebugMsg("DOUBLESTAR test -> pick_argument");
        }
#line 3626 "parse.tab.c" /* yacc.c:1646  */
    break;
...
#line 3635 "parse.tab.c" /* yacc.c:1646  */
    break;
...
#line 3643 "parse.tab.c" /* yacc.c:1646  */
    break;
...
#line 3651 "parse.tab.c" /* yacc.c:1646  */
    break;
...
#line 3659 "parse.tab.c" /* yacc.c:1646  */
    break;
...
#line 3667 "parse.tab.c" /* yacc.c:1646  */
    break;
...
#line 3675 "parse.tab.c" /* yacc.c:1646  */
    break;

  case 314:
#line 1481 "parse.y" /* yacc.c:1646  */
    { printDebugMsg("YIELD testlist -> yield_expr"); }
#line 3681 "parse.tab.c" /* yacc.c:1646  */
    break;

  case 315:
#line 1483 "parse.y" /* yacc.c:1646  */
    { printDebugMsg("YIELD -> yield_expr"); }
#line 3687 "parse.tab.c" /* yacc.c:1646  */
    break;


#line 3691 "parse.tab.c" /* yacc.c:1646  */
      default: break;
    }
